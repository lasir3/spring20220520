...
<script>
	$(document).ready(function() {
				...
				success : function(list) {
					...
					$(".reply-delete-button").click(function() {
						...
						if (confirm(message)) {
							...
							$.ajax({
								url : "${appRoot}/reply/delete/" + replyId, // path
								type : "delete", // 지울때 전송 타입
								success : function(data) {
		...
		//addReplySubmitButton1 버큰 클릭시 ajax 댓글 추가 요청
		...
		<div class="row">
			<div class="col">
				...
				<form id="form1" action="${appRoot }/board/modify" method="post">
					...
					<div>
						<img src="https://bucket0207-230491.s3.ap-northeast-2.amazonaws.com/board/${board.id }/${board.fileName }" alt="" />
					</div>
